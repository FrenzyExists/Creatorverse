...
const Card = ({ creator, id }: CardInformation) => {
  ...
  return (
    <article className="group relative rounded-3xl border-[4px] border-gray-800">
      <Link
        to={`/creator/${id}`}
        className="w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-96"
      >
        <img
      ...
      <div className="mt-4 flex justify-between items-center">
        <h3 className="text-lg text-gray-800 font-extrabold">{creator.name}</h3>
        <div className="flex">
